...
module.exports = {
  ...
  setFromSite: function (site) {
    ...
    this.config.newslettersignup.confirmationEmail.attachments =
      (config.ideas &&
        config.ideas.feedbackEmail &&
        config.ideas.feedbackEmail.attachments) ||
      this.config.newslettersignup.confirmationEmail.attachments;
    this.config.newslettersignup.confirmationEmail.subject =
      (config.ideas &&
        config.ideas.feedbackEmail &&
        config.ideas.feedbackEmail.subject) ||
      this.config.newslettersignup.confirmationEmail.subject;
