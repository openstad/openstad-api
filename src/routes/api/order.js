    ...
    .post(async function (req, res, next) {
        ...
        if (paymentProvider === 'stripe') {
            ...
            try {
                ...
                let stripeSessionConfig;

                if (subscriptionInterval === 'once') {
                    stripeSessionConfig = {
                        mode: 'payment',
                        //
                        ...
                        metadata: {
                            ...
                            amountOfDaysAccess: subscriptionProduct.extraData.accessDays ? subscriptionProduct.extraData.accessDays : 35,
                            orderId: req.results.id,
                            userId: req.user.id
                        },
