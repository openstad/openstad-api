    ...
    Action.types = [
        {
            ...
            act: async (action, selectedResource, req, res) => {
                ...
                // if user is present move on
                if (req.user) {
                    return;
                }

                // how to ensure to come back here?
                let url = `/oauth/site/${req.data.global.siteId}/login?redirectUrl=${returnUrl}&useOauth=anonymous`;
